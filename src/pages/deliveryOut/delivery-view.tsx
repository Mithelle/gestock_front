...
import { useDeleteDeliveryOut } from "@/features/deliveryOUT/deliveryOut.service";
...
export default function DeliveryViewPage(){
    const [productId, setProductId] = useState('');
        ...
        const deleteDeliveryOut = useDeleteDeliveryOut();
        function onDelete(id: string){
            deleteDeliveryOut.mutate(id)
            router.reload();
        }
     ...
     <div className="flex w-full">
      <div className="grid grid-cols-4 gap-12">
       <div className="text-sm font-light text-slate-500">
        <p className="text-sm font-normal text-slate-700">Bordereau de livraison n:</p>
        <p>BL2023000012</p>
