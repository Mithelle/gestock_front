...
import { useGetAllPackage, useGetAllPackageByProduct } from "@/features/package/packaging.service";
...
export default function StorePage() {
    ...
    const toastId = toast.loading('En cours...');
        try{
         const response =  await addInventory ({...data, product_id: productId, package_id: packageId})
    ...
    return (
        ...
        <div className="px-6 py-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div>
                <select onChange={handleProductChange}  id="product_id" className="block  px-4 py-2 mt-2 text-gray-500 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600">
            ...
            <div className="w-full mt-4">
                    <input {...register("quantity")} className="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-500 bg-white border rounded-lg dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300" type="number" min={0} placeholder="Quantité" aria-label="qte" />
                </div>
                <div className="w-full mt-4">
